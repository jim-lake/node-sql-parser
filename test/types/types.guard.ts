...
export function isLoadDataLine(obj: unknown): obj is LoadDataLine {
    ...
    return (
        ...
        (typeof typedObj["starting"] === "undefined" ||
            ...
            typeof typedObj["starting"]["type"] === "string" &&
